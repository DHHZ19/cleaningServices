      ...
      <div className="relative mx-auto max-w-7xl py-24 sm:py-32 lg:px-8 lg:py-40">
        <div className="pr-6 pl-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pr-0 lg:pl-24 xl:pl-32">
          ...
          <p className="mt-6 text-base/7 text-gray-600">
            For more than 20 years, L & J’s Cleaning Services delivers cleaning
            services to residential and commerical businesses of the Twin Cities
            metro area. Offering a variety of services all catered to the need
            of our valued clients. We offer customizable cleanings, scheduled
            cleanings, deep cleanings and more.
          </p>
          <div className="mt-8">
            <a
              href="#contact-us"
